...
//        wmNewsAutoScanService.autoScanWmNews(wmNews.getId());
    ...
    @Override
    public ResponseResult cat(Integer id) {
        if (id == null){
            return ResponseResult.errorResult(AppHttpCodeEnum.PARAM_INVALID);
        }
    ...
    public ResponseResult delNews(Integer id) {
        //0.校验参数
        if (id == null){
            return ResponseResult.errorResult(AppHttpCodeEnum.NEWS_ID_IS_SHORTCOMING);
        }
        //1.查询文章
        WmNews wmNews = wmNewsMapper.selectById(id);
        ...
        if (wmNews == null){
            ...
            return ResponseResult.errorResult(AppHttpCodeEnum.NEWS_OVER_PUBLISH);
        }
        //3.先删除文章和素材的关系关系
